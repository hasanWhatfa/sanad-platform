...
const ACTIVE_LINK_KEY = 'active_sidebar_link';

const SideBar = ({ links }: SideBarProps) => {
    const [activeLink, setActiveLink] = useState<string>(() => {
        return localStorage.getItem(ACTIVE_LINK_KEY) || links[0].linkText;
    });
    ...
    const handleLogOut = () => {
        ...
        localStorage.removeItem(ACTIVE_LINK_KEY);
        navigate('/');
    }

    return (
        <div className={`sideBar_container ${isOpen ? 'active' : ''}`}>
